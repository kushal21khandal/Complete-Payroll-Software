        ...
        if (path_client_csv == null) {
            ...
            while (!(input = mainBufferedReader.readLine()).equals("quit")) {
                ...
                if (mainBufferedReader.readLine().trim().equalsIgnoreCase("y")) {
                    /*
                    for setting incentive use case only for one time
                     */
                    ...
                    /*
                    for taking incentive input everytime from the user for each entry
                     */
                    calc_incentive = Double.parseDouble(mainBufferedReader.readLine().trim());
                } else {
                    calc_incentive = 0;
            ...
            try {
                ...
                while ((input = fileBufferedReader.readLine()) != null) {
                    ...
                    // add one column for incentive also
                    // if (inputArr.length == 5 || inputArr.length == 4 || inputArr.length == 3) {
                    if (inputArr.length == 5 || inputArr.length == 4 ) {
                        // EmployeeDatabaseHandler.printEmployeeDetails(inputArr[0]);
                        /*
                         * first 2 columns if length == 4 then uan and name : then salary and attendance
                         * else only first column uan : then salary and attendance
                         * only name is optional , else uan , total_salary , attendance , calc_incentive compulsory
                         */
                        ...
                        if (inputArr.length == 5) {
                            ...
                            calc_incentive = Double.parseDouble(inputArr[3]);
                        }
                        // else {
                        //     // uan , name , salary , attendance : 4 cols
                        //     total_salary = Double.parseDouble(inputArr[2]);
                        //     attendance = Double.parseDouble(inputArr[3]);
                        // }
                        ...
                        /*
                         * cols : uan_no , salary  : included into the client csv file
                         * taking input for attendance
                         */
                        EmployeeDatabaseHandler.printEmployeeDetails(inputArr[0]);
                        ...
                        /*
                         * cols : uan only
                         * taking input for salary and attendance
                         */
